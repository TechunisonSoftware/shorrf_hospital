...
def create_medical_record(doc, method=None):
	...
	#Saving our doctypes to patient medical records
	...
	# print(doc.doctype)
	# print(get_patient_history_doctypes())
	# print("---------------------------")

	# print("Doctype condition checking ")

	if doc.doctype not in get_patient_history_doctypes():
		return
	
	# print("Doctype present in patient history doctypes ")
